...
const VedioTitle = ({ title, overview }) => {
  return (
    <div className="h-[650px] absolute top-10 sm:top-2 md:-top-5 left-0 z-20 flex flex-col justify-center bottom-0 w-full pl-4 sm:pl-6 md:pl-10 aspect-video bg-gradient-to-t from-black from-10%">
